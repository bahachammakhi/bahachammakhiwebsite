...
export default function contact() {
  return (
    <Layout>
      <body class="bg-white text-gray-100 px-8 pb-12">
        <div class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-white text-gray-900 rounded-lg shadow-lg">
          <div class="flex flex-col justify-between">
            <div>
              ...
              <div class="text-gray-700 mt-8">
                ...
                <a
                  href="mailto:bahaeddinechammakhi@gmail.com"
                  class="underline"
                >
                  email
                </a>{" "}
          ...
          <form
            action="https://getform.io/f/f2890ca8-84b0-450d-b730-ed62020cc484"
            method="POST"
          >
            <div>
            ...
            <div class="mt-8">
              <button
                type="submit"
                class="uppercase text-sm font-bold tracking-wide bg-blue-600 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline"
              >
                Send Message
              </button>
            </div>
